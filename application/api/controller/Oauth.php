...
class Oauth {
  ...
  private function authCheck () {
    ...
    header("Location:https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx9c7b6afdec97691d&redirect_uri=https%3A%2F%2Fv.cunhao.net%2Fcounty%2Fhome%2Fd%3Fwid%3D105%26snsapi%3Dbase&response_type=code&scope=snsapi_base&state=&component_appid=wx54fc5424f9be5442#wechat_redirect");
    // exit($openid);
    // if(empty($_GET['url']))
    //   $this->state = 'null';
